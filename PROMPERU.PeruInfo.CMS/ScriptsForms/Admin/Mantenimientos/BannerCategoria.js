$(document).ready(function () {
    ...
    $("#fileImagenDesktop").change(function (e) {
        ...
        $.ajax({
            url: `${baseURL}bannercategoria/upload`,
            type: "post",
            contentType: false,
            processData: false,
            data: formData,
    ...
    $("#ddlCategoria").change(function() {
        $("#hdnCategoriaId").val($("#ddlCategoria").val());
    });
...
function ListarBloques() {
    ...
    var table = $("#gridBloques").DataTable({
        ...
        "ajax": `${baseURL}bannercategoria/listar`,
        "deferRender": true,
        "columns": [
            { "data": "TraduccionId" },
            { "data": "IdiomaNombre" },
...
function LlenarDatosBloque() {
    ...
    const categoriaId = $("#hdnCategoriaId").val();
...
function RegistrarBloque() {
    ...
    $.ajax({
        url: `${baseURL}bannercategoria/insertar`,
...
function SeleccionarBloque(bannerTraduccionId) {
    ...
    $.ajax({
        url: `${baseURL}bannercategoria/seleccionar`,
...
function SeleccionarBloquePorIdioma(bannerId, idiomaId) {
    ...
    $.ajax({
        ...
        success: function (response) {
            if (response !== null && response !== undefined) {
                $("#hdnCategoriaId").val(response.CategoriaId);
...
function ActualizarBloque(bannerTraduccionId) {
    ...
    $.ajax({
        url: `${baseURL}bannercategoria/actualizar`,
    ...
    confirm("¿Está seguro de eliminar el Bloque?",
        function (result) {
            if (result) {
                ...
                $.ajax({
                    url: `${baseURL}bannercategoria/eliminar`,
